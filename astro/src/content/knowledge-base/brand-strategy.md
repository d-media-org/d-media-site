...
При `d . media` официалното изписване на името е стратегически принцип. `d . media` се използва последователно в съдържанието, метаданните и публичните сигнали, за да не се размива брандът.

Друг казус е ролята на Knowledge Base като постоянна база знания. Това е стратегически избор: `d . media` да обяснява устойчиви принципи и проверими основи, вместо да разчита само на кратки публикации.

Трети казус е необходимостта всяка публична система да има ясен и поддържан източник на съдържание. Когато техническата основа е ясна, съдържанието и брандът имат по-малък риск от разминаване.
