...
Препоръките в останалата част на статията не са представени като официален стандарт. Те са практически изводи от съчетаването на тези източници с нуждата всеки бранд да поддържа последователни страници, метаданни и редакционни правила.
...
В среда като `d . media` брандингът не е само файл с лого. Той се проявява в етикетите в навигацията, текстовете на страниците, метаданните, структурираните данни, изображенията за споделяне, страниците на услуги и страниците на проекти.
...
При `d . media` официалното изписване `d . media` се използва последователно, а публичното съдържание не представя лична самоличност като част от бранда. Това предпазва идентичността от неясни или неоторизирани сигнали.

Друг пример е връзката между стабилната техническа основа и преживяването на бранда. Скоростта, правилните адреси, метаданните и предвидимото публикуване влияят пряко върху това как изглежда и работи брандът онлайн.
