...
const bg: AuthorityPage[] = [
  {
    ...
    sections: [
      ...
      { title: "06. Публикуване", text: "Използваме build, preview, production и логика за връщане към предишна версия вместо непроверени директни промени." },
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Технология според проекта", text: "Astro, CMS, commerce, Cloudflare, Vercel или друга среда се избират според целта, собствеността и поддръжката." },
      ...
      { title: "Проверка след промяна", text: "Всяка съществена промяна минава през build, проверка на маршрути, визуална проверка и проверка за публикуване според риска." },
    ],
  },
  {
    slug: "technologies",
    ...
    eyebrow: "технологии",
    description: "Технологичният подход на d . media към Astro, CMS, commerce, Cloudflare, Vercel, интеграции, аналитика и поддръжка.",
    ...
    sections: [
      { title: "Static-first и Astro", text: "Подходящи за сайтове с много съдържание и представителни сайтове, когато ниският runtime риск и скоростта са приоритет." },
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Runtime", text: "Клиентският JavaScript се използва само за реална интерактивност, а не като модел за рендериране по подразбиране." },
      ...
      { title: "Контрол върху регресии", text: "Build, обхождане и визуални бързи проверки се повтарят преди production deployment." },
    ],
  },
  {
    slug: "faq",
