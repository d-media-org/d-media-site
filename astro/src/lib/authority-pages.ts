...
const bg: AuthorityPage[] = [
  {
    ...
    eyebrow: "процес",
    description: "Процесът на d . media за контекст, обхват, дизайн, разработка, QA, публикуване и поддръжка.",
    intro: "Работим в ясна последователност, която намалява неяснотата преди изпълнение и риска от regressions след публикуване.",
    sections: [
      ...
      { title: "02. Обхват", text: "Разделяме задължителното от допълнителното и описваме deliverables, срокове, зависимости и начин на одобрение." },
      { title: "03. Архитектура", text: "Подреждаме съдържание, визуална система, потребителски поток, technology stack и технически сигнали според проекта." },
      { title: "04. Изпълнение", text: "Работим на контролирани етапи, за да може всяко решение да бъде проверено преди следващото." },
      { title: "05. QA", text: "Проверяваме съдържание, responsive поведение, accessibility, performance, SEO, GEO и реалните сценарии за използване." },
      { title: "06. Публикуване", text: "Използваме build, preview, production и rollback логика вместо непроверени директни промени." },
      { title: "07. Поддръжка", text: "След публикуване системата може да продължи с monitoring, updates, content development и контрол върху regressions." },
    ],
  },
  {
    slug: "methodology",
    title: "Методология",
    eyebrow: "методология",
    description: "Методологията на d . media за свързване на бранд идентичност, съдържание, дизайн, уеб, SEO, GEO и performance.",
    ...
    sections: [
      ...
      { title: "Система преди единичен asset", text: "Търсим повторяема логика за типография, композиция, content formats, components и touchpoints." },
      { title: "Съдържание преди interface decoration", text: "Работим с реални заглавия, текстове, езици и ограничения, за да избегнем красив, но неизползваем шаблон." },
      { title: "Технология според проекта", text: "Astro, CMS, commerce, Cloudflare, Vercel или друга среда се избират според целта, ownership и поддръжката." },
      { title: "Доказателства преди обещания", text: "Разграничаваме потвърдени резултати, наблюдения и цели. Не използваме фиктивни metrics или гаранции за ranking." },
      { title: "Проверка след промяна", text: "Всяка съществена промяна минава build, route, visual и production validation според риска." },
    ],
  },
  {
    slug: "technologies",
    ...
    eyebrow: "технологии",
    description: "Технологичният подход на d . media към Astro, CMS, commerce, Cloudflare, Vercel, integrations, analytics и поддръжка.",
    intro: "Не продаваме конкретен stack като универсален отговор. Избираме най-малката достатъчна система за съдържанието, функциите и дългосрочната поддръжка.",
    sections: [
      { title: "Static-first и Astro", text: "Подходящи за content-heavy и представителни сайтове, когато ниският runtime риск и performance са приоритет." },
      ...
      { title: "Commerce", text: "Shopify, WooCommerce и други commerce решения се оценяват според каталог, плащания, операции и integrations." },
      { title: "Cloudflare и Vercel", text: "Deployment платформата се избира според functions, static delivery, build process, ownership и реалните operational нужди." },
      { title: "Integrations", text: "CRM, payments, booking, email и analytics се добавят само когато подкрепят ясен процес." },
      { title: "Portability", text: "Кодът, assets, domain и конфигурацията се подреждат така, че проектът да не остава неясно заключен към доставчик." },
    ],
  },
  {
    slug: "performance",
    title: "Performance стандарт",
    eyebrow: "performance",
    description: "Performance стандартът на d . media за Core Web Vitals, PageSpeed, mobile stability, accessibility и regression control.",
    intro: "Производителността е част от архитектурата и QA процеса, не финален декоративен badge.",
    sections: [
      { title: "Измерване", text: "Използваме лабораторни тестове и когато е налично field data, без да представяме единичен run като постоянна гаранция." },
      { title: "Assets", text: "Изображенията имат размери, подходящ формат и контролирано loading поведение. Шрифтовете запазват бранда с оптимизиран delivery." },
      { title: "Runtime", text: "Клиентският JavaScript се използва само за реална интерактивност, а не като default rendering модел." },
      { title: "Mobile stability", text: "Проверяваме memory, gallery, navigation и reload сценарии в подходящи browser engines, включително WebKit при iOS риск." },
      { title: "Accessibility", text: "Добрата производителност не се постига чрез премахване на semantic структура, focus states или достатъчно съдържание." },
      { title: "Regression control", text: "Build, crawl и visual smoke checks се повтарят преди production deployment." },
    ],
  },
  {
    slug: "faq",
    ...
    eyebrow: "faq",
    description: "Отговори за услугите, процеса, цените, технологиите, SEO, GEO, performance и поддръжката на d . media.",
    intro: "Кратки отговори на въпроси, които определят правилния обхват преди начало на проект.",
    sections: [],
    faqs: [
      { question: "Какви услуги предлага d . media?", answer: "Бранд идентичност, съдържание, управление на социални медии, графичен дизайн, реклама, уеб дизайн, уеб разработка, техническо SEO, GEO, performance оптимизация и техническа поддръжка." },
      ...
      { question: "Работите ли само с Astro и Cloudflare?", answer: "Не. Избираме технологията и инфраструктурата според проекта, клиента, integrations и поддръжката." },
      { question: "Гарантирате ли първо място в Google или AI цитиране?", answer: "Не. Подобряваме техническата основа, съдържанието, entity clarity и доказателствата, но търсачките и AI системите контролират ranking и source selection." },
      { question: "Как се определя цената?", answer: "Според deliverables, сложност, обем, срок, integrations, права и нужната поддръжка. Публикуваните стойности са начални рамки, когато има потвърден стандартен обхват." },
      { question: "Може ли да поемете съществуващ сайт?", answer: "Да, след преглед на кода, платформата, content layer, достъпите и натрупания риск." },
