...
const bg: AuthorityService[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "CSS и layout", text: "Ограничаваме конфликтните правила, разместванията на layout и разхода за rendering без визуален компромис." },
      ...
      { title: "Контрол върху regressions", text: "След всяка промяна повтаряме build, проверка на ключови страници и device проверки, защото единичен резултат не доказва стабилност." },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Наблюдение", text: "Следим наличност, build/deploy резултати, сигнали за индексиране и ключови отклонения в скоростта според обхвата." },
      ...
      { title: "Backup и rollback", text: "Поддържаме ясна версия на кода и история на публикуванията, за да може проблемна промяна да бъде изолирана." },
