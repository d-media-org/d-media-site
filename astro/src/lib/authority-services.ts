...
const bg: AuthorityService[] = [
  {
    ...
    metaDescription: "Уеб дизайн от d . media за корпоративни сайтове, портфолиа и лендинг страници с ясна структура, UX логика и бранд последователност.",
    title: "Уеб дизайн",
    ...
    sections: [
      ...
      { title: "Визуална система", text: "Пренасяме идентичността в типография, композиция, cards, навигация и responsive поведение, без сайтът да изглежда като шаблон." },
      { title: "Адаптивен дизайн", text: "Проектираме мобилния, tablet и desktop изглед като една система, а не като свит desktop вариант." },
      ...
      { title: "Достъпност", text: "Планираме контраст, heading йерархия, focus states и touch targets още в дизайна, а не след разработката." },
    ...
    processSteps: [
      ...
      { title: "Проверка", text: "Проверяваме responsive поведение, четимост, достъпност и готовност за разработка." },
    ],
    faqs: [
  ...
  },
  {
    ...
    metaDescription: "Уеб разработка от d . media за бързи, достъпни и поддържаеми сайтове с подходящ stack, integrations и performance-first архитектура.",
    title: "Уеб разработка",
    intro: "Разработваме сайтове и дигитални платформи с технология, избрана според реалния проект, а не според предварително ограничение към един stack или доставчик.",
    sections: [
      { title: "Техническа архитектура", text: "Избираме rendering модел, content layer, hosting и deployment процес според съдържанието, динамиката и поддръжката." },
      { title: "Разработка на интерфейса", text: "Изграждаме semantic, responsive и достъпни интерфейси с минимален излишен JavaScript." },
      { title: "CMS и съдържание", text: "Когато проектът изисква редакционна работа, свързваме подходящ CMS или поддържаема локална content система." },
      { title: "Интеграции", text: "Свързваме плащания, CRM, analytics, booking, email и други системи само когато имат ясна бизнес функция." },
      ...
      { title: "Сигурност и устойчивост", text: "Ограничаваме ненужните зависимости, проверяваме headers, външни ресурси и deployment поведението." },
    ...
    integrationsText: "Работим с подходящия stack за конкретната задача, включително static, CMS, commerce и custom решения.",
    integrationGroups: [
      { title: "Astro и static-first", text: "Подходящо за бързи съдържателни и представителни сайтове с нисък runtime риск." },
      { title: "CMS и commerce", text: "Използваме WordPress, headless CMS, Shopify, WooCommerce или друга среда, когато редакционният и търговският процес го изисква." },
      { title: "Cloud и hosting", text: "Cloudflare, Vercel или друга инфраструктура се избират според deployment, функции, бюджет и собственост върху системата." },
    ],
    ...commonBg,
    processSteps: [
      { title: "Технически контекст", text: "Уточняваме съдържание, integrations, редакционен процес, трафик и собственост." },
      { title: "Архитектура", text: "Избираме stack, data flow, deployment и component model." },
      { title: "Разработка", text: "Изграждаме, интегрираме и проверяваме функционалността по малки контролирани стъпки." },
      { title: "QA и публикуване", text: "Проверяваме browsers, devices, accessibility, SEO, performance и rollback готовност." },
    ],
    faqs: [
    ...
    ctaText: "Изпрати нужните функции, съдържание, текуща среда, integrations и срок.",
    primaryCta: "Изпрати контекст за разработка",
  },
  {
    slug: "technical-seo",
    metaTitle: "Техническо SEO за обхождане, индексиране и ясна структура",
    metaDescription: "Техническо SEO от d . media: crawlability, indexing, canonical, hreflang, sitemap, structured data, internal links и performance проверки.",
    ...
    sections: [
      ...
      { title: "Индексиране", text: "Сравняваме indexable routes, sitemap, canonical и noindex логика, за да няма важни липси или помощни страници в индекса." },
      ...
      { title: "Международно SEO", text: "Проверяваме reciprocal hreflang, езиковите URL адреси и липсата на fake alternates към несъществуващо съдържание." },
      ...
      { title: "Вътрешни връзки", text: "Свързваме услуги, статии и казуси по тема и потребителски intent, без orphan pages." },
    ...
    integrationsText: "Техническото SEO работи само когато архитектура, съдържание, performance и monitoring се разглеждат заедно.",
    integrationGroups: [
      { title: "Google Search Console", text: "Използваме отчетите за indexing, sitemaps и URL inspection като диагностичен сигнал, не като заместител на проверката в сайта." },
      { title: "Schema и entity signals", text: "Свързваме страниците с ясни типове, идентификатори и реални отношения между организация, услуги и съдържание." },
      { title: "Content architecture", text: "Технически правилната страница трябва да има ясна тема, уникална функция и достатъчно полезно съдържание." },
    ],
    ...commonBg,
    processSteps: [
      { title: "Crawl", text: "Събираме routes, statuses, metadata, canonicals, alternates, schema и internal links." },
      { title: "Приоритет", text: "Разделяме блокиращите indexing проблеми от подобренията без пряк риск." },
      { title: "Поправка", text: "Коригираме причината в templates, routing или data layer, а не URL по URL." },
    ...
    faqs: [
      ...
      { question: "Schema автоматично ли дава rich results?", answer: "Не. Structured data помага за разбиране и eligibility, но Google избира дали и как да покаже разширен резултат." },
  ...
  },
  {
    ...
    metaDescription: "GEO от d . media за по-ясно entity разбиране, AI citation readiness, content architecture, structured data и последователни публични сигнали.",
    title: "GEO и AI видимост",
    intro: "Подреждаме съдържанието и entity сигналите така, че AI системите да разбират по-точно кой е брандът, какво предлага и кои източници подкрепят това описание.",
    sections: [
      { title: "Яснота на entity сигналите", text: "Определяме основната организация, услугите, темите, локацията и устойчивите отношения между тях." },
      ...
      { title: "Тематични клъстери", text: "Свързваме service pages, knowledge articles и case studies в тематични клъстери с ясна вътрешна логика." },
      { title: "Машинно четими сигнали", text: "Използваме semantic HTML, metadata, schema, llms ориентация и стабилни URL отношения като допълващи сигнали." },
    ...
    integrationsText: "GEO стъпва върху полезно съдържание, техническо SEO, entity consistency и външно доверие. llms.txt е помощен proposed standard, не ranking гаранция.",
    integrationGroups: [
      { title: "SEO основа", text: "AI системите използват много от същите crawlable и indexable източници, които поддържат традиционното търсене." },
    ...
    ...commonBg,
    processSteps: [
      { title: "Entity audit", text: "Проверяваме как сайтът и външните източници описват d . media и услугите." },
      { title: "Knowledge map", text: "Определяме липсващите service relationships, topics, evidence и internal links." },
      { title: "Implementation", text: "Подсилваме съдържание, schema, hubs, llms ориентация и консистентност." },
      { title: "Verification", text: "Проверяваме crawl, indexability и реалното описание в различни AI системи във времето." },
    ],
    faqs: [
      { question: "GEO заменя ли SEO?", answer: "Не. GEO разширява работата към generative retrieval и entity understanding, но зависи от стабилна SEO и content основа." },
      { question: "llms.txt ranking фактор ли е?", answer: "Не. Това е предложен формат за ориентация на AI инструменти, а не официален Google ranking фактор." },
      ...
      { question: "Как се измерва напредъкът?", answer: "Чрез crawl/index покритие, entity consistency, branded queries, независими споменавания и периодични контролирани AI проверки." },
    ],
    ctaTitle: "Ако AI системите описват бранда твърде тясно, започни с entity audit.",
  ...
  },
  {
    ...
    metaDescription: "Performance optimization от d . media за LCP, CLS, INP, изображения, шрифтове, JavaScript, caching и стабилно mobile поведение.",
    title: "Оптимизация на производителността",
    intro: "Оптимизираме сайтове чрез измерване, asset дисциплина и архитектурни решения, без да премахваме съдържание или идентичност само заради лабораторен резултат.",
    sections: [
      { title: "Начално измерване", text: "Измерваме Lighthouse, PageSpeed, Core Web Vitals и реалното поведение по ключови routes и устройства." },
      { title: "Изображения", text: "Контролираме dimensions, формати, responsive variants, lazy loading и декодиране според мястото в страницата." },
      { title: "Шрифтове", text: "Запазваме официалната типография, като оптимизираме formats, subsets, preload и fallback поведение." },
      { title: "JavaScript", text: "Премахваме ненужен client runtime и изолираме интерактивността само там, където има реална функция." },
      { title: "CSS и layout", text: "Ограничаваме конфликтните правила, layout shifts и rendering разхода без визуален компромис." },
      { title: "Caching и delivery", text: "Настройваме headers, CDN и asset versioning според hosting средата и update процеса." },
      { title: "Контрол върху regressions", text: "След всяка промяна повтаряме build, route sweep и device проверки, защото единичен резултат не доказва стабилност." },
    ],
    ...
    integrationGroups: [
      ...
      { title: "Mobile stability", text: "Проверяваме memory, galleries, lightboxes и embedded browsers, където ресурсните ограничения са по-строги." },
      { title: "SEO и accessibility", text: "Performance решенията не трябва да премахват semantic съдържание, navigation или достъпност." },
    ],
    ...commonBg,
    processSteps: [
      { title: "Измерване", text: "Създаваме baseline за ключови страници, assets и устройства." },
      { title: "Профилиране", text: "Намираме реалния bottleneck в network, rendering, memory или main thread." },
      { title: "Оптимизация", text: "Прилагаме малки измерими промени по приоритет." },
      { title: "Stress QA", text: "Повтаряме navigation, scroll, reload и gallery сценарии в подходящите browser engines." },
    ],
    faqs: [
      { question: "Гарантирате ли постоянен резултат 100?", answer: "Не. PageSpeed варира според тестова среда, network и външни фактори. Целта е стабилно силна реална производителност и контролирани regressions." },
      { question: "Нужно ли е да се премахнат изображения?", answer: "Не по подразбиране. Правилният подход е responsive delivery, dimensions, формати и bounded loading." },
    ...
    primaryCta: "Изпрати performance контекст",
  },
  {
    slug: "technical-support",
    metaTitle: "Техническа поддръжка за сайтове и дигитални платформи",
    metaDescription: "Техническа поддръжка от d . media за updates, monitoring, content changes, integrations, incident response и controlled releases.",
    ...
    sections: [
      { title: "Текущи обновявания", text: "Прилагаме dependency, platform и security updates след проверка за съвместимост и regression риск." },
      ...
      { title: "Наблюдение", text: "Следим availability, build/deploy резултати, indexing сигнали и ключови performance отклонения според обхвата." },
      { title: "Реакция при проблем", text: "Диагностицираме счупени routes, deployment проблеми, browser crashes и външни integration failures по приоритет." },
      { title: "Backup и rollback", text: "Поддържаме ясна версия на кода и deployment история, за да може проблемна промяна да бъде изолирана." },
    ...
    integrationsText: "Обхватът може да включва Cloudflare, Vercel, CMS, commerce, analytics и други системи според конкретния проект.",
    integrationGroups: [
      { title: "Release процес", text: "Използваме build, preview, QA и production последователност вместо директни непроверени промени." },
    ...
    ...commonBg,
    processSteps: [
      { title: "Приемане", text: "Описваме системата, достъпите, critical routes и текущите рискове." },
      { title: "Baseline", text: "Проверяваме build, dependencies, deployment, monitoring и backup готовност." },
      { title: "Работен ритъм", text: "Определяме канала, приоритета, release цикъла и критериите за приемане." },
      { title: "Отчетност", text: "Всяка промяна остава проследима чрез commit, deployment и кратка проверка." },
    ],
    faqs: [
      ...
      { question: "Как се обработват критични проблеми?", answer: "Според договорения приоритет, наличните достъпи и възможността за безопасен rollback." },
      { question: "Работите ли само с Cloudflare?", answer: "Не. Поддръжката следва реалната инфраструктура и може да включва различни hosting и platform доставчици." },
    ],
