...
const seeds: EnglishPostSeed[] = [
  ...
  },
  {
    ...
    category: "web-presence",
    title: "The architecture behind d-media.org's PageSpeed results",
    excerpt: "The architectural decisions behind the earlier documented PageSpeed scores of d-media.org and the limits of those records.",
    intro: "The earlier documented PageSpeed/Lighthouse scores are 100/100/100/100 on desktop and 98/100/100/100 on mobile. No dated primary report is available, so they are not presented as current measurements.",
    focus: "the architecture behind earlier documented PageSpeed scores, not a current benchmark",
  ...
  },
  {
    ...
    title: "Documented Lighthouse scores for d-media.org",
    excerpt: "A case study on the architecture and earlier documented Lighthouse scores, which are not presented as current measurements.",
    intro: "d-media.org was developed as a working platform, not a demonstration page. This case study describes its architecture and earlier documented Lighthouse scores; no dated primary report is available.",
    focus: "the architecture and earlier documented performance scores of d-media.org",
    relatedPosts: ["kak-postignahme-100-100-v-google-pagespeed-insights", "zashto-100-100-v-pagespeed-ne-garantira-dobar-sait"],
    featured: true,
  },
];
