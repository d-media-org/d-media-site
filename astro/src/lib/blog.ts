  ...
  "patyat-do-d-media": [
    {
      title: "Контекст",
      paragraphs: [
        "Пътят до d . media не е просто смяна на име. Това е преход от по-тясно рекламно и визуално присъствие към по-събрана студийна система, в която идентичност, съдържание, уеб, дизайн и реклама работят заедно.",
