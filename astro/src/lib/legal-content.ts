  ...
  bg: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "такси за лиценз за използване и прехвърляне на имуществени права",
      ],
      ...
      subsections: [
        ...
        },
        {
          ...
          subsections: [
            ...
            {
              id: "5.4.6",
              title: "Лицензи и имуществени права",
              content: [
                "Клиентът може да заплати такса за неизключителен или изключителен лиценз за използване. Пълно прехвърляне на имуществени права се урежда само по индивидуално договаряне.",
              ],
            },
          ],
        },
