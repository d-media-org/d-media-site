...
const pageCopy = {
  bg: {
    ...
    home: {
      ...
      pricingText: "Показваме начални рамки за най-честите стартови обхвати. Те дават реалистична първа посока, а финалният обхват се подрежда според проекта.",
      pricingRangeCue:
      ...
      pricingGroups: [
        {
          ...
          items: [
            ...
            { title: "Премиум дигитална платформа", price: "от 4 990 €" },
          ],
        },
        {
      ...
      pricingGroups: [
        {
          ...
          items: [
            ...
            { title: "Premium digital platform", price: "from 4,990 €" },
          ],
        },
        {
