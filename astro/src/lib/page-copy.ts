...
const pageCopy = {
  bg: {
    ...
    home: {
      ...
      trustText:
        "Платформата d-media.org е проектирана, разработена и поддържана от d . media с Astro, Cloudflare, архитектура с фокус върху скоростта и ясна основа за Google и AI търсене. Текущият PageSpeed Insights baseline е 98/100/100/100 на mobile и 100/100/100/100 на desktop.",
