      ...
      pricingGroups: [
        {
          title: "Уеб дизайн и разработка",
          items: [
            { title: "Страница за кампания или услуга", price: "690 € (1 349 лв.)" },
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Автоматизация на маркетингови действия", price: "290 € (567 лв.)" },
      ...
      pricingGroups: [
        {
          ...
          items: [
            ...
            { title: "Графичен дизайн за YouTube (банер, миниатюра и др.)", price: "34,99 € / 68,43 лв." },
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Графичен дизайн за YouTube (банер, миниатюра и др.)", price: "49,99 € / 97,77 лв." },
      ...
      pricingGroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { title: "Изпълнение без авторски кредит", price: "19,99 € / 39,10 лв." },
