...
const baseProjectPngArchive = [
  {
    ...
    "focus": [
      ...
      "Звукова продукция, звуков дизайн, запис, монтаж и миксиране",
    ...
    "caseStudySections": [
      ...
      { "title": "Визуална система", "text": "Разработена е свързана визуална система с лога, логотипи, корици за Facebook, графики за подкаста, шаблони, варианти за Коледа и Нова година и редактируеми файлове във формати AI и PSD." },
      { "title": "Подкаст", "text": "Подкаст направлението разширява проекта отвъд Facebook общностите. Архивът съдържа оригинално интро, джингъл, разширено интро, разширен микс, пълна тема, кратко интро, фонова версия, заключителна версия, чиста версия, струнни варианти, клубни и етно редакции, запис, монтаж, миксиране, аудио реклама, видео версия и тийзър. Има завършен E0 и суров запис за E1; E1 не е представен като публикуван епизод." },
  ...
  },
  {
    ...
    "focus": [
      ...
      "SEO, GEO и многоезична архитектура за реална употреба",
      "Реални приложения на бранда и архив от 155 анимирани варианта"
    ],
    "caseStudySections": [
      {
      ...
      {
        "title": "Архитектура",
        "text": "Платформата премина от първоначален сайт с Next.js към архитектура с Astro и Cloudflare Pages, ясни маршрути, локални публични ресурси и съгласувана езикова структура на български и английски."
      },
      {
        "title": "Performance",
      ...
      },
      {
        ...
        "text": "Преминаването към Astro намали натоварването на сайта при изпълнение и направи поведението му по-предвидимо при статично публикуване, проверка на маршрутите и дългосрочна поддръжка."
      },
      {
        "title": "Миграция към Cloudflare",
        "text": "Преместването към Cloudflare Pages осигури по-чиста инфраструктура, пряк контрол върху домейна и процес за предварителен преглед и публикуване, като премахна активната зависимост от предишен външен слой за файлови ресурси."
      },
      {
        "title": "SEO и GEO готовност",
        "text": "Метаданните, canonical адресите, hreflang, sitemap, schema, изображенията за споделяне в социалните мрежи и llms файловете са подредени за индексиране в търсачки и AI системи. За основните публични страници са добавени политика Content-Signal и договаряне на съдържанието във формат Markdown."
      },
      {
        "title": "Визуална система",
        "text": "Сайтът запазва типографията Panton, монохромната редакционна посока, изображения за споделяне само с логотипа и минимална визуална система без декоративен шум."
      },
      {
        "title": "Галерии и мобилна стабилност",
        "text": "Галериите бяха оптимизирани чрез PNG файлове и ограничен набор от техни уеб варианти. За визуализациите бяха приложени отделни решения за портретен и пейзажен формат, както и допълнителни проверки за стабилност в iPhone и Safari."
      },
      {
        "title": "Анимационна система",
        "text": "Казусът включва 155 оптимизирани начални анимации с логотип и други анимационни варианти, със статични кадри за преглед и отложено зареждане. Така анимациите остават достъпни, без да забавят първоначалното зареждане на страницата."
      },
      {
        "title": "Резултат",
        "text": "d-media.org служи като собствен пример за работа: идентичност, реални приложения, съдържание, проектен и анимационен архив и уеб платформа, изградени по същия стандарт, който предлагаме."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "focus": [
      ...
      "Прозрачен вариант на логото за пряко приложение",
      "Визитка — лице и гръб"
    ],
    "videos": [
      {
    ...
    "caseStudySections": [
      ...
      {
        "title": "Система",
        "text": "Разработени са знак, оригинален и български логотип, приложения за визитки и анимиран вариант, които образуват последователна визуална система."
      },
      {
        "title": "Резултат",
  ...
  },
  {
    ...
    "context": "Подборът вече е фокусиран върху комбинирания знак, логотипа и самостоятелното решение с лого в прозрачни файлове.",
    "focus": [
      "Комбиниран прозрачен знак",
      "Прозрачен логотип",
      "Прозрачен знак на логото"
    ],
  },
  {
    "slug": "diana",
  ...
  },
  {
    ...
    "featured": false,
    "priority": 999,
    "summary": "Визуален пакет за продукт с изчистени черно-бели варианти и ясно име.",
    "context": "Задачата беше да се изведе името с максимална четимост и чиста продуктова визуална рамка.",
    "focus": [
      "Черно-бял вариант на логото",
...
const localizedProjectCopy = {
  bg: {
    "elena-skevov-mua": {
      summary: "Дизайн на визитка за Elena Skevov MUA, показан от двете страни.",
      context: "Материалите показват лицевата и задната страна на визитката с визуалния знак на Elena Skevov MUA.",
      focus: ["Визуален знак", "Дизайн на визитка", "Лице и гръб на визитката"],
    },
    "monika-hristova": {
    ...
    teti: {
      summary: "Визуална система за салон, представена чрез четири визитки, ценоразпис и работно време.",
      context: "Галерията показва четири визитки, ценоразпис и информация за работното време на салона.",
      focus: ["Четири визитки", "Ценоразпис", "Работно време на салона"],
    },
  },
  en: {
    ...
    "elena-skevov-mua": {
      summary: "Business card design for Elena Skevov MUA, shown from both sides.",
      context: "The material shows the front and back of the business card with Elena Skevov MUA’s visual mark.",
      focus: ["Visual mark", "Business card design", "Front and back of the card"],
    },
    "monika-hristova": {
    ...
    teti: {
      title: "Teti",
      summary: "A salon visual system shown through four business cards, a price list, and working hours.",
      context: "The gallery shows four business cards, the price list, and information about the salon’s working hours.",
