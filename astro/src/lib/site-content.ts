...
const localizedSiteContent = {
  bg: {
    ...
    coreServices: [
      ...
      },
      {
        ...
        text: "Текстове, визуални формати и серии съдържание, съобразени с темата и канала.",
        includes: "Текстове, визуални формати, серии съдържание, адаптации и работна структура за сайт, кампании и канали.",
        audience: "За брандове, които искат последователен изказ и съдържание за конкретни страници, кампании или канали.",
        result: "Получаваш текстове и визуални формати, свързани с една комуникационна посока.",
      ...
      },
      {
        ...
        text: "Планиране и поддръжка на социални канали с формати, календар и постоянен ритъм.",
        includes: "Социални формати, корици, серии, адаптации, календарна рамка и работен ритъм за публикуване.",
        audience: "За брандове, които искат някой да планира и координира редовното им присъствие в социалните мрежи.",
        result: "Получаваш календар, формати и текуща координация на публикациите.",
      ...
      },
      {
        ...
        text: "Сайтове и уеб платформи с ясна структура, добра скорост и основа за търсене.",
        ...
        result: "Получаваш бърз сайт с ясна структура, поддръжка, интеграции и основа за Google и AI търсене.",
  ...
  en: {
    mainNavigation: [
      ...
      { href: "/about", label: "About d . media" },
    ...
    coreServices: [
      ...
      },
      {
        ...
        result: "You get copy and visual formats shaped around one communication direction.",
        detailHref: "/services/content-creation",
      ...
      },
      {
        ...
        result: "You get a publishing calendar, defined formats, and ongoing coordination.",
        detailHref: "/services/social-media-management",
      ...
      },
      {
        ...
        text: "Websites and digital platforms with clear structure, strong performance, and a foundation for search.",
        ...
        result: "You get a fast website with clear structure, maintainability, integrations, and a foundation for search and AI search.",
        detailHref: "/services/web-design-development",
