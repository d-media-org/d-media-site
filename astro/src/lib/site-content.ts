  ...
  bg: {
    ...
    coreServices: [
      ...
      },
      {
        ...
        text: "Техническа основа за правилно обхождане, индексиране, canonical, hreflang, schema и вътрешни връзки.",
        includes: "Crawl и index audit, sitemap, redirects, structured data, international SEO и validation.",
        audience: "За сайтове с indexing проблеми, структурни промени или нужда от по-ясна техническа SEO основа.",
      ...
      },
      {
        ...
        text: "Entity, content и machine-readable сигнали за по-точно разбиране и цитируемост в AI търсене.",
        includes: "Entity audit, topic clusters, citation-ready content, schema, llms ориентация и consistency проверка.",
        audience: "За брандове, които AI системите описват непълно, неточно или твърде тясно.",
        result: "Получаваш по-ясна knowledge architecture и последователно публично позициониране.",
      ...
      },
      {
        ...
        text: "Оптимизация на Core Web Vitals, assets, fonts, JavaScript, caching и mobile stability без загуба на идентичност.",
        includes: "Baseline, profiling, asset optimization, browser QA и regression control.",
        audience: "За сайтове с бавно зареждане, нестабилно mobile поведение или performance regressions.",
        result: "Получаваш измерима и проверена производителност, а не еднократен лабораторен резултат.",
        detailHref: "/services/performance-optimization",
        detailLabel: "Виж обхвата за performance оптимизация",
      },
      {
        id: "technical-support",
        title: "Техническа поддръжка",
        text: "Контролирани updates, releases, monitoring, content промени и реакция при технически проблем.",
        includes: "Maintenance, incident response, SEO проверки, backup/rollback логика и документация.",
        audience: "За сайтове, които трябва да останат стабилни, актуални и проследими след публикуване.",
        result: "Получаваш ясен release процес и поддръжка без хаотични промени.",
