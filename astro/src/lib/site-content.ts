  ...
  bg: {
    ...
    coreServices: [
      ...
      },
      {
        ...
        text: "Текстове, визуални формати и content серии, подредени в ясна комуникационна линия.",
        includes: "Текстове, визуални формати, content серии, адаптации и работна структура за сайт, кампании и канали.",
        audience: "За брандове, които имат нужда от ясен изказ и последователно съдържание, не от отделни несвързани публикации.",
        result: "Получаваш content обхват с текстова и визуална логика, подготвен за реална употреба.",
