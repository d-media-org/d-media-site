...
const localizedSiteContent = {
  bg: {
    ...
    coreServices: [
      {
        ...
        result: "Получаваш система за лого, цветова рамка и базови правила за сайт, документи и реклама.",
      ...
      },
      {
        ...
        includes: "Корпоративни сайтове, портфолио сайтове, представителни сайтове, страници за кампания или услуга, дигитални платформи, многоезични сайтове, интеграции и основа за Google и AI търсене според проекта.",
        audience: "За брандове и бизнеси, които имат нужда от сайт като работеща платформа, не просто визуална страница.",
        result: "Получаваш бърз сайт с ясна структура, стабилна основа, възможност за поддръжка, интеграции и готовност за Google и AI търсене.",
      ...
      },
      {
        ...
        text: "Техническа основа, която помага на търсачките да намират, разбират и подреждат правилните страници.",
        includes: "Проверка на обхождане и индексиране, sitemap, пренасочвания, структурирани данни, многоезични версии и валидация.",
        audience: "За сайтове с проблеми при индексиране, структурни промени или нужда от по-ясна техническа SEO основа.",
        result: "Получаваш поправени системни причини и проверима основа за търсачки.",
        detailHref: "/services/technical-seo",
        detailLabel: "Виж обхвата за техническо SEO",
      },
      {
        id: "geo",
        title: "GEO и AI видимост",
        text: "Съдържание и машинночетими сигнали, които помагат на AI системите да разбират по-точно бранда.",
        includes: "Проверка на публичното описание на бранда, тематични групи, съдържание, подходящо за цитиране, структурирани данни и проверка за последователност.",
        audience: "За брандове, които AI системите описват непълно, неточно или твърде тясно.",
        result: "Получаваш по-ясна информационна структура и последователно публично позициониране.",
        detailHref: "/services/geo",
        detailLabel: "Виж обхвата за GEO",
      },
      {
        id: "performance-optimization",
        title: "Оптимизация на скоростта",
        text: "Оптимизация на скоростта, изображенията, шрифтовете, JavaScript, кеширането и стабилното мобилно поведение без загуба на идентичност.",
        includes: "Начално измерване, диагностика, оптимизация на файловете, проверка в браузъри и контрол след промени.",
        audience: "За сайтове с бавно зареждане, нестабилно мобилно поведение или повтарящи се технически проблеми след промени.",
        result: "Получаваш измерима и проверена скорост, а не еднократен лабораторен резултат.",
        detailHref: "/services/performance-optimization",
        detailLabel: "Виж обхвата за оптимизация на скоростта",
      },
      {
        id: "technical-support",
        title: "Техническа поддръжка",
        text: "Контролирани обновявания, публикувания, наблюдение, съдържателни промени и реакция при технически проблем.",
        includes: "Поддръжка, реакция при проблем, SEO проверки, резервни копия, логика за връщане към предишна версия и документация.",
        audience: "За сайтове, които трябва да останат стабилни, актуални и проследими след публикуване.",
        result: "Получаваш ясен процес за публикуване и поддръжка без хаотични промени.",
        detailHref: "/services/technical-support",
        detailLabel: "Виж обхвата за техническа поддръжка",
      },
      {
        id: "graphic-design",
      ...
      },
      {
        ...
        text: "Приоритет, работа без авторски кредит, работа на място и права за използване, подредени като отделен обхват, когато проектът го изисква.",
        includes: "Приоритетни начисления, работа без авторски кредит, работа с клиент на място и рамки за лицензиране или прехвърляне на права.",
    ...
    termsSections: [
      ...
      { title: "Оперативни политики", text: "Конкретни ситуации като ревизии, работни файлове, външни акаунти, бюджети, поддръжка и предаване се уреждат от приложимите оперативни политики." },
    ...
    privacySections: [
      { title: "Какви данни", text: "Имена, адрес, телефон, имейл, платежна информация и технически идентификатори, когато това е нужно за услугата или сайта." },
  ...
  en: {
    ...
    coreServices: [
      ...
      },
      {
        id: "technical-seo",
        title: "Technical SEO",
        text: "A technical foundation for crawling, indexing, canonical, hreflang, schema, and internal linking.",
        includes: "Crawl and index audit, sitemap, redirects, structured data, international SEO, and validation.",
        audience: "For websites with indexing problems, structural changes, or a weak technical SEO foundation.",
        result: "You receive systemic fixes and a verifiable foundation for search engines.",
        detailHref: "/services/technical-seo",
        detailLabel: "View the technical SEO scope",
      },
      {
        id: "geo",
        title: "GEO and AI Visibility",
        text: "Entity, content, and machine-readable signals for more accurate understanding and citation readiness in AI search.",
        includes: "Entity audit, topic clusters, citation-ready content, schema, llms guidance, and consistency checks.",
        audience: "For brands that AI systems describe incompletely, inaccurately, or too narrowly.",
        result: "You receive clearer knowledge architecture and consistent public positioning.",
        detailHref: "/services/geo",
        detailLabel: "View the GEO scope",
      },
      {
        id: "performance-optimization",
        title: "Performance Optimization",
        text: "Core Web Vitals, assets, fonts, JavaScript, caching, and mobile stability without losing brand identity.",
        includes: "Baseline, profiling, asset optimization, browser QA, and regression control.",
        audience: "For websites with slow loading, unstable mobile behaviour, or recurring performance regressions.",
        result: "You receive measured and verified performance rather than a one-off laboratory score.",
        detailHref: "/services/performance-optimization",
        detailLabel: "View the performance scope",
      },
      {
        id: "technical-support",
        title: "Technical Support",
        text: "Controlled updates, releases, monitoring, content changes, and response to technical incidents.",
        includes: "Maintenance, incident response, SEO checks, backup and rollback logic, and documentation.",
        audience: "For websites that need to remain stable, current, and traceable after launch.",
        result: "You receive a clear release process and support without chaotic changes.",
        detailHref: "/services/technical-support",
        detailLabel: "View the technical support scope",
      },
      {
        id: "graphic-design",
    ...
    termsSections: [
      ...
      { title: "Operational policies", text: "Specific situations such as revisions, working files, external accounts, budgets, support, and delivery are governed by the applicable operational policies." },
