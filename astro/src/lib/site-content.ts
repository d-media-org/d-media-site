  ...
  bg: {
    ...
    coreServices: [
      ...
      },
      {
        ...
        includes: "Корпоративни сайтове, портфолио сайтове, бизнес презентации, лендинг страници, Astro разработка, Cloudflare Pages, SEO и GEO основа.",
        audience: "За брандове и бизнеси, които имат нужда от сайт като работеща платформа, не просто визуална страница.",
        result: "Получаваш бърз сайт с ясна структура, стабилна основа и готовност за търсене, AI search и дългосрочно развитие.",
  ...
  en: {
    ...
    coreServices: [
      ...
      },
      {
        ...
        includes: "Corporate websites, portfolio websites, business presentation websites, landing pages, Astro development, Cloudflare Pages, SEO and GEO foundations.",
        audience: "For brands and businesses that need a website as a working platform, not just a visual page.",
        result: "You get a performance-first website with clear structure, stable delivery, and readiness for search, AI search, and long-term development.",
        detailHref: "/services/web-design-development",
