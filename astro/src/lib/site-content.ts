...
const localizedSiteContent = {
  bg: {
    ...
    aboutSummary: [
      ...
      "Обхватът постепенно се разширява към рекламни и дигитални материали, а след това и към уеб разработка.",
      "Днес направленията могат да се комбинират или да се възложат отделно според проекта.",
    ],
    testimonials: {
      eyebrow: "отзиви",
  ...
  en: {
    ...
    aboutSummary: [
      ...
      "The scope gradually expanded to advertising and digital materials, followed by web development.",
      "Today, these areas can be combined or commissioned separately according to the project.",
    ],
    testimonials: {
